...
function registration() {
    ...
    $.ajax({
        type: 'post',
        url: 'http://localhost:8080/carsales/ajax/registration',
        data: data,
        dataType: 'text',
...
function getAllCars() {
    $.ajax({
        type: 'get',
        url: 'http://localhost:8080/carsales/ajax/allcars',
        dataType: 'json',
        error: [function(xhr, status, error) {
            alert(xhr.responseText + '|\n' + status + '|\n' + error);
        }],
...
function filterRequest() {
    ...
    $.ajax({
        type: 'get',
        url: 'http://localhost:8080/carsales/ajax/filters',
...
$(document).ready(function () {
    ...
    $.ajax({
        type: 'get',
        url: 'http://localhost:8080/carsales/ajax/allbrand',
        dataType: 'json',
        error: [function(xhr, status, error) {
            alert(xhr.responseText + '|\n' + status + '|\n' + error);
        }],
